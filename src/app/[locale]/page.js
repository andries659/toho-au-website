...
function DownloadButton() {
  ...
  return (
    ...
    >
      ...
      {downloadUrl ? t.home.downloadBtn : t.home.fetchingRelease}
    </a>
  );
}
        ...
        <main className="tor-main">
          ...
          <FadeSection delay={0}>
            <section className="tor-hero">
              <div className="tor-eyebrow">{t.home.eyebrow}</div>
              <h1 className="tor-h1">
                {t.home.titleLine1} <span className="tor-gradient-text">{t.home.titleLine2}</span><br />
                {t.home.titleLine3}
              </h1>
              <p className="tor-sub">
                {t.home.subtitle}
              ...
              <div className="tor-cta-row">
                <DownloadButton />
                <Link href="/guide" className="tor-btn-secondary">{t.home.guideBtn} →</Link>
                <Link href="/starlight" className="tor-btn-secondary tor-btn-starlight">✦ {t.home.starlightBtn}</Link>
              </div>
            </section>
          </FadeSection>
          ...
          <FadeSection delay={80}>
            <section className="tor-panel">
              ...
              <div className="tor-feature-grid">
                {[
                  { icon: <FaPalette />, title: t.home.coloredUi,    desc: t.home.coloredUiDesc },
                  { icon: <FaPuzzlePiece />, title: t.home.customRoles, desc: t.home.customRolesDesc },
                  { icon: <FaCog />,     title: t.home.gameOptions,   desc: t.home.gameOptionsDesc },
                  { icon: <FaGamepad />, title: t.home.gamemodes,      desc: t.home.gamemodesDesc },
                ].map(({ icon, title, desc }) => (
